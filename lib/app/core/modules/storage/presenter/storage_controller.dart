...
class StorageController implements IStorageController {
  ...
  Future<bool> delete(String key) async {
    ...
    return result.fold((l) => throw DeleteError(message: '${l.message}'), (r) => true);
  }

  @override
  Future<bool> put(String key, Map value) async {
    var result = await _put(key, value);
    return result.fold((l) => throw PutError(message: '${l.message}'), (r) => true);
  }

  @override
  Future<Map> read(String key) async {
    var result = await _read(key);
    return result.fold((l) => throw ReadError(message: '${l.message}'), (r) => r);
  }

  @override
  Future<bool> update(String key, Map value) async {
    var result = await _update(key, value);
    return result.fold((l) => throw UpdateError(message: '${l.message}'), (r) => true);
  }
